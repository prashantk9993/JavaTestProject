...
public class SeconfHighestNumer {
    public static void main(String[] args) {
        ...
        list.stream().distinct().sorted((n1,n2)->n2.compareTo(n1)).skip(2).limit(1).forEach(System.out::println);
        list.stream().sorted((n1,n2)->n2.compareTo(n1)).skip(1).limit(1).forEach(System.out::println);
